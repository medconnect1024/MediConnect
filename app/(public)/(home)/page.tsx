...
export default function Home() {
  return (
    <>
      <Header />
      <div className="flex flex-col min-h-screen w-full bg-blue-50 overflow-hidden relative">
        <main className="flex-2">
          <section className="w-full min-h-screen flex items-center justify-center bg-gradient-to-b from-blue-900 via-blue-400 to-blue-200 relative">
            <SparklesCore
          ...
          <section className="w-full py-12 md:py-24 lg:py-32 bg-blue-500 text-white relative">
            <div className="container px-4 md:px-6 mx-auto relative z-10">
              <div className="flex flex-col items-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="mx-auto max-w-[600px] text-blue-100 md:text-xl">
                    Join thousands of healthcare professionals already
                    benefiting from MyMediRecords's AI-powered solutions.
                  </p>
                </div>
                <div className="w-full max-w-sm space-y-2">
                  <form className="flex space-x-2">
        ...
        <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t border-blue-200 relative z-10">
          <p className="text-xs text-blue-800">
